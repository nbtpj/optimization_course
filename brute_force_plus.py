...
def solve(method, x, y_with_outliers, a, N, args):
    import sccf
    ...
    prob.solve(method=method, step_size=args.step_size, maxiter=args.maxiter, tol=args.tol, verbose=True)
    end_time = time.time()
    running_time = end_time - start_time
    return theta[0].value, running_time

brute_force_sol = lambda x, y_with_outliers, a, N, args: solve('brute_force', x, y_with_outliers, a, N, args)
sccf_sol = lambda x, y_with_outliers, a, N, args: solve('alternating', x, y_with_outliers, a, N, args)
